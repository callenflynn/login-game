document.addEventListener('DOMContentLoaded', () => {
    ...
    const passwordRequirements = [
        ...
        { regex: /[\u{1F600}-\u{1F64F}]/u, message: 'must have at least one emoji' },
        ...
        { regex: /(?:cat|dog|elephant|lion|tiger|bear|wolf|fox|rabbit|deer)/i, message: 'must have at least one animal name' },
